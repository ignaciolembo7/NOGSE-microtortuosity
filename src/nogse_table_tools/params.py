...
def read_sequence_params_xlsx(path: str | Path) -> pd.DataFrame:
    ...
    for sheet in xls.sheet_names:
        ...
        for c in ["seq", "Hz", "bmax", "delta_ms", "delta_app_ms", "N", "gthorsten_mTm", "d_ms", "TE_ms", "TR_ms", "TM_ms"]:
            if c in sub.columns:
    ...
    col_order = [c for c in ["sheet","protocol","seq","Hz","bmax","d_ms","delta_ms","delta_app_ms","N","gthorsten_mTm","seq_type","TE_ms","TR_ms","TM_ms"] if c in params.columns]
